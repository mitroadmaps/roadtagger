...
def TOPOGenerateStartingPoints(OSMMap, check = True, density = 0.00050, region = None, image = None, direction = False, metaData = None, RoadNetworkCallback= None ):
	result = []
				...
				for j in range(len(node_list)-1):
					...
					if alpha * dist >= dists[j] and alpha * dist <= dists[j+1]:
						...
						if img != None:
							...
							lat_mergin = 0.07*(region[2]-region[0])
							lon_mergin = 0.07*(region[3]-region[1])
